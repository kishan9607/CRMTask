...
@section('contain')
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Lead Managment</h1>
                        <a href="{{ route('leads.create') }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">Add Lead</a>
                    </div>
                    ...
                    <table id="datatable" class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $item->status }}</td>
                                <td>
                                    <a href="{{ route('leads.edit',$item->id) }}" class="btn btn-primary btn-sm">Edit</a>
                                    <button type="button" onclick="deleteItam({{$item->id}})" class="btn btn-danger btn-sm">Delete</button>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
