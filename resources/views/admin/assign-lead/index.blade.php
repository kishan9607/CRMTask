...
@section('contain')
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Assign Lead to User</h1>
                        <a href="{{ route('assign-leads.create') }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">Assign Lead</a>
                    </div>
